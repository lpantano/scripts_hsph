...
Maybe it would help to detect weird samples to show the amount of the different type of small RNA against the total reads with adapters.
...
Replicate 1 seems different than the other two.
...
Show is the count ratio of Day0/Day5
...
Just to know what happens if only use miRNA for normalization.
