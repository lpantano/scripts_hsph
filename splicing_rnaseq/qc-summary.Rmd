...
rmat_nf_nicm = c(SE=56582, MXE=9436, A5SS=3359, A3SS=5149, RI=4160)
...
```{r rMATS}
nf_icm = list.files("~/orch/scratch/anyu_splicing/cardio_failure/work/rmat/NF_ICM_2/MATS_output/", "ReadsOnTargetAndJunctionCounts",full.names = T)
