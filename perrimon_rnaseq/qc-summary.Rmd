...
```{r plotpca}
plotPCA(rlog_ma,ntop=1000) + ggtitle("top 1000 variable genes")
plotPCA(rlog_ma,ntop=10800) + ggtitle("all genes")
plotPCA(rlog_ma, intgroup="experiment",ntop=1000)
```
...
intersect(seq_de$row, array_de$ensemble)
...
sum(dhyper(39:min(sample1,sample1), sample1, totalpop-sample1, sample2))
