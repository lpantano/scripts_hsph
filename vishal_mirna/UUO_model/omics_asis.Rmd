...
# render_2_drop("omics_asis.Rmd", "vishal_kidney/UUO_omics_ournorm")
```
...
result_files = "~/orch/scratch/vishal_mirna_kidney/UUO-model/omics/files_asis"
...
counts = read.csv(file.path(root_path, "UUO_Proteomics_RawData.csv"),skip = 1) %>% tidyr::separate(Protein.Id, c("sp", "Uniprot.ID", "type"),sep = "[::|::]", extra = "merge")
...
# clean_counts = clean_counts[as.character(coun$id),]
...
name_res = compress_results(protein_file, prefix = "uoo_model_prot_asis", zip = TRUE)
