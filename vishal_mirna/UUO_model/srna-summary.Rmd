...
#render_2_drop("srna-summary.Rmd", "vishal_kidney/UOO_small_rna")
```
...
res =  results(dss)
deg_res = show_deseq2_results(res, dss, rlogMat, "uuo_model_mirna", 
...
deg_res = show_deseq2_results(res, dss_mirdeep2, rlogMat,
                              "uuo_model_novel", 
                    FDR=0.01, FC=2, group=NULL, xs="group",
                    org=org.Mm.eg.db, 
                    path_results = root_file, do_go=FALSE,
...
res =  results(dss_iso)
deg_res = show_deseq2_results(res, dss_iso, rlogMat,
                              "uuo_model_iso", 
                    FDR=0.01, FC=2, group=NULL, xs="group",
                    org=org.Mm.eg.db, 
                    path_results = root_file, do_go=FALSE,
...
deg_res = show_deseq2_results(res, dss_clus, rlogMat,
                              "uuo_model_cluster", 
                    FDR=0.01, FC=2, group=NULL, xs="group",
                    org=org.Mm.eg.db, 
                    path_results = root_file, do_go=FALSE,
...
name_res = compress_results(root_file,prefix = "uoo_model_mirna")
```
