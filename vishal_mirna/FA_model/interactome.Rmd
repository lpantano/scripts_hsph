...
# render_2_drop("interactome.Rmd", "vishal_kidney/FA_small_rna")
```
...
```{r annotation-calc}
viz_info = viz_mirna_gene_enrichment(data, mirna_clean, mrna_clean, mirna_g, org.Mm.eg.db)
save_file(viz_info$table, "interaction.tsv", root_file)
```
