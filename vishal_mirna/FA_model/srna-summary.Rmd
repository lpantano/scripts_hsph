...
obj <- IsomirDataSeqFromFiles(files = files, design = design , header = T)
```
...
print_out = function(dss, rlog=NULL, res=NULL, prefix="data_"){
  ...
  if (length(sign)<2){
    ...
    pheatmap(rlogmat[sign, ], show_rownames = F, clustering_distance_cols = "correlation", clustering_method = "ward.D2")
    mds(rlogmat[sign,], condition = colData(dss)$condition)
  }
