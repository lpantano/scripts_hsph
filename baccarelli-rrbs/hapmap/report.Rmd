...
path_files = "~/repos/pipelines/baccarelli-rrbs/"
...
Two replicates of NA12878 hapmap sample were analyzed with bissnp to compare between them and to the truth set of SNP from GiaB.
...
Extra SNP seems to be product of bisulfite treatment. A/G in the minus strand so T/C in the +.
