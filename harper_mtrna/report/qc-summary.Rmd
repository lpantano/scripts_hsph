...
knitr::kable( tab_anno %>% filter(chromosome_name=="MT") )
```
...
`r knitr::kable( tab_anno_non_filtered %>% filter( grepl("MT-T",external_gene_name) & pvalue<0.06 ) )`
...
`r knitr::kable(tab_anno_single %>% filter(grepl("TRMT",external_gene_name) & pvalue<0.05 ) )`


`r knitr::kable( tab_anno_single %>% filter( grepl("MT-T",external_gene_name) ) )`
...
`r knitr::kable(tab_anno_all %>% filter(grepl("TRMT",external_gene_name) & pvalue<0.3 ) ) `


`r knitr::kable( tab_anno_all %>% filter( grepl("MT-T",external_gene_name) ) ) `
...
# Coverage along tRNA-Lys

MT-TL is the Lys-tRNA
