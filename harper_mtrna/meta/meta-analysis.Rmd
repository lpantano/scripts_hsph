...
render_2_drop("~/repos/pipelines/harper_mtrna/",dn)
...
read_projects = function(project_summary, counts_file){
  ...
  list(summarydata$group, counts)
}

pro1 = read_projects("~/orch/groups/harper_rnaseq/mtrna/final-mt/2015-01-14_mtrna/project-summary.csv",
"~/orch/groups/harper_rnaseq/mtrna/final-mt/2015-01-14_mtrna/combined.counts")
rep_counts = pro1[[2]]
...
"~/orch/scratch/harper_mitrna_2/data_May_01/mitrna/final/2015-05-04_mitrna/combined.counts")


pro3 = read_projects("~/orch/scratch/harper_mitrna_2/Jun_22/mitrna/final/2015-06-22_mitrna/project-summary.csv",
"~/orch/scratch/harper_mitrna_2/Jun_22/mitrna/final/2015-06-22_mitrna/combined.counts")
...
[convstreat1](`r get_report_links(paste0(path_files,'controlvstreat1_ann.tsv'))`)
[convstreat2](`r get_report_links(paste0(path_files,'controlvstreat2_ann.tsv'))`)
[treat2vstreat2](`r get_report_links(paste0(path_files,'treat1vstreat2_ann.tsv'))`)
