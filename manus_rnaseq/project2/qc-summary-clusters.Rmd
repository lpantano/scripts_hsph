...
This analysis only takes into account sequences < 40nt.
...
do_norm = function(dss, root_path, prefix){
    ...
    fn_log = paste0(path_results, prefix, "log_matrix.txt")
    write.table(rlog_ma,fn_log,sep="\t")
    fn_count = paste0(path_results, prefix, "count_matrix.txt")
    write.table(count_ma,fn_count,sep="\t")
    fn_raw = paste0(path_results, prefix, "raw_matrix.txt")
...
fn = paste0(path_results, "clusters_de.tsv")
...
fn = paste0(path_results, "mirna_de.tsv")
