...
# render("~/repos/pipelines/noga_rnaseq/qc-summary.Rmd")
```
...
with RUVSeq, a package that tries to get that all replicate samples are the most similar as possible.
...
kable(as.data.frame(table(out_df$padj<0.1)))
...
Top 20 significantly deregulated genes with Padj < 0.1
