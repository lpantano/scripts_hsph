...
fa_de = rownames(fa_matrix[fa_matrix$adj.P.Val<0.05 & rowMax(abs(as.matrix(fa_matrix[,1:11]))) > 1, ])
save_file(fa_de, "prot_fa_selected.csv", path_results)
```
...
## Clustering analysis
```{r ann-cluster}
ann_meta = function(prot_meta, fa_de, absMaxFC, prot_early_clusters, prot_late_clusters, fn){
    ...
    prot_meta[add_fa, "fa"] <- prot_meta_fa[add_fa, "fa"]
...
prot_meta = ann_meta(prot_meta, fa_de, absMaxFC, prot_early_clusters, prot_late_clusters, "prot_meta.tsv")
```
...
prot_meta = ann_meta(prot_meta, fa_de, absMaxFC, prot_early_clusters, prot_late_clusters, "prot_norm_meta.tsv")
```
...
ann_meta = function(pprot_meta, absMaxFC, pprot_early_clusters, pprot_late_clusters, fn){
...
pprot_meta = ann_meta(pprot_meta, absMaxFC, pprot_early_clusters, pprot_late_clusters, "phospho-prot_meta.tsv")
```
...
pprot_meta = ann_meta(pprot_meta, absMaxFC, pprot_early_clusters, pprot_late_clusters, "phospho-prot_norm_meta.tsv")
```
