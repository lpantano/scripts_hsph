...
In this study there are no replicates. I use the values at they are
...
prot_meta$early_cluster = prot_early_clusters$df[row.names(prot_meta),2]
prot_meta$late_cluster = prot_late_clusters$df[row.names(prot_meta),2]
...
pprot_meta$early_cluster = pprot_early_clusters$df[row.names(pprot_meta),2]
pprot_meta$late_cluster = pprot_late_clusters$df[row.names(pprot_meta),2]
