...
summarydata$Alias = paste(summarydata$Name, summarydata$genotype, summarydata$age, sep = "_")
...
res =  results(dds)
de_res = degResults(res, dds, rlogMat, "mice_model_late", FDR=0.05, FC=0.5, path_results = path_results, org = org.Mm.eg.db)
```
