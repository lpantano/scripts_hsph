...
```{r mds}
late_exp = read.table(file.path(late_path, "mice_model_late_log2_counts.tsv"), sep=",", header=T, row.names=1)
early_exp = read.table(file.path(early_path, "mice_model_log2_counts.tsv"), sep=",", header=T, row.names=1)
...
late_df_cond = read.table(file.path(late_path, "mice_model_jck_wt.tsv"), sep=",", header=T, row.names=1)
...
early_df_cond = read.table(file.path(early_path, "mice_model_jck_wt.tsv"), sep=",", header=T, row.names=1)
...
main[as.character(late_clus_cond$genes), "cluster_early"] = late_clus_cond$cluster
main[as.character(early_clus_cond$genes), "cluster_late"] = early_clus_cond$cluster
