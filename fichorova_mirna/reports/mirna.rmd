...
set_norm = RUVg(set, controls, k=2)
...
aheatmap( cpm_ruv[max.cv,], annCol = metadata[,c(2,4)], annLegend = TRUE,hclustfun="ward",annColors = list(Expcode=cols1,pato=cols2), labRow  = row.names(cpm_ruv[max.cv,]) )
```
