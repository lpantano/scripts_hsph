...
```{r qc-setup}
project_summary = "~/orch/scratch/simulator/hd/rna/final/2016-11-20_rna/project-summary.csv"
counts_file = "~/orch/scratch/simulator/hd/rna/final/2016-11-20_rna/combined.counts"
tx2genes_file = "~/orch/scratch/simulator/hd/rna/final/2016-11-20_rna/tx2gene.csv"
...
save_file(counts %>% tibble::rownames_to_column("GENEID") %>% mutate(GENENAME=convertIDs(GENEID, "GENEID", "GENENAME", 
EnsDb.Hsapiens.v79)), "gene_counts.csv", dirname(project_summary))
save_file(as.data.frame(counts_norm) %>% tibble::rownames_to_column("GENEID") %>% mutate(GENENAME=convertIDs(GENEID, "GENEID", "GENENAME", 
EnsDb.Hsapiens.v79)), "gene_norm_counts.csv", dirname(project_summary))
```
